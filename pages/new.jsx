        ...
        <div className="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
          <div className="flex">
            <div className="relative flex items-center gap-x-4 rounded-full py-1 px-4 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
              <span className="font-semibold text-indigo-600">SpaceWarp</span>
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            Filecoin deals are temporary, but they don't have to be. F5 enables the continued refreshing of storage deals.
            Storage providers 
          </p>
